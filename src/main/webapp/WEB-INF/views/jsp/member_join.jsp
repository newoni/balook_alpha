        ...
        <div class="join_container">
            ...
            <form id ="info" name="join" method="post">
                <ul>
                    ...
                    <li><input id ="id" name = "id" type="text" placeholder="ID" required="required"></li>
                    <li>PASSWORD</li>
                    <li><input id ="pw" name = "pw" type="password" placeholder="PASSWORD" required="required"></li>
                    <li>PASSWORD CHECK</li>
                    <li><input id ="pwcheck" type="password" placeholder="PASSWORD" required="required"></li>
                    <li>NAME</li>
                    ...
                    <li>PHONE</li>
                    <li><input id ="phone" name = "phone" type="number" placeholder="PHONE (숫자로만 입력해주세요.)" required="required" size="11"></li>
                </ul>
                <div class="joinus">
...
<script>
    ...
    function information() {
        document.getElementById("info").addEventListener('submit', (e) => {
            ...
            console.log({obj});
            document.getElementById('json_result').innerHTML = JSON.stringify(data);
        });
    }
    // <21.06.29> KH start
    function sendJSON(obj1){
        xhr.onload = function() {
        ...
        xhr.open('POST', 'customer/signUp/');
        xhr.setRequestHeader('Content-Type', 'application/json'); // 컨텐츠타입을 json으로
        xhr.send(JSON.stringify(obj1)); // 데이터를 stringify해서 보냄
    }
